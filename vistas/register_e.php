...
<body style="overflow: hidden;">
    <section class="container">
        <form action="../logica/user.php" method="POST" onSubmit="inputsEmpty();">
            ...
            <br>
            <div class="form-box">
            <input type="text" class="input-box" placeholder="Ingrese su nombre" name="nombre" required>
            <input type="email" class="input-box" placeholder="Ingrese su correo" name="correo" required>
            <input type="password" class="input-box" placeholder="Ingrese su contraseña" name="contrasenia" required> 
            <input type="text" class="input-box" placeholder="Ingrese su localidad" name="localidad" required>
            ...
            <input type="text" name="estado" value="10" hidden>
