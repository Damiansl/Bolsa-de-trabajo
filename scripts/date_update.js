...
export function SendMail(email){
    ...
    let params = {
        ...
        message: "¡Hola!, hemos visto que no has actualizado tus datos desde hace un tiempo, actualiza tus datos para que las empresas esten al tanto de ti y puedas tener mas oportunidades laborales."
    };
